...
/***/ "./constants/frontEndConstants.ts":
/*!****************************************!*\
  !*** ./constants/frontEndConstants.ts ***!
  \****************************************/
/*! exports provided: COOKIE_NAME, GRAPHQL_SERVER_URL */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GRAPHQL_SERVER_URL", function() { return GRAPHQL_SERVER_URL; });
var COOKIE_NAME = "QID";
var GRAPHQL_SERVER_URL = "http://localhost:4000/graphql";
...
/* harmony import */ var _constants_frontEndConstants__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../constants/frontEndConstants */ "./constants/frontEndConstants.ts");
...
function create(initialState, _ref) {
  ...
  var httpLink = Object(apollo_link_http__WEBPACK_IMPORTED_MODULE_2__["createHttpLink"])({
    uri: "".concat(_constants_frontEndConstants__WEBPACK_IMPORTED_MODULE_4__["GRAPHQL_SERVER_URL"]),
    credentials: "include"
  }); // destructure headers from request object, get token from it and
  // add as cookie property back into headers, if found

  var authLink = Object(apollo_link_context__WEBPACK_IMPORTED_MODULE_1__["setContext"])(function (_, _ref2) {
    var headers = _ref2.headers;
    var token = getToken(); // passed in from initApollo setup

    return {
      headers: _objectSpread({}, headers, {
        cookie: token ? "".concat(_constants_frontEndConstants__WEBPACK_IMPORTED_MODULE_4__["COOKIE_NAME"], "=").concat(token) : ""
      })
    };
...
/* harmony import */ var _constants_frontEndConstants__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../constants/frontEndConstants */ "./constants/frontEndConstants.ts");

var _jsxFileName = "/Users/jasonjones/GitHubData/BenAwad/typescript-nextjs-graphql-series/lib/withApollo.tsx";
                ...
                case 0:
                  ...
                  apollo = Object(_initApollo__WEBPACK_IMPORTED_MODULE_6__["default"])({}, {
                    getToken: function getToken() {
                      return parseCookies(req)["".concat(_constants_frontEndConstants__WEBPACK_IMPORTED_MODULE_8__["COOKIE_NAME"])];
                    } // [] in lieu of .name
...
var _jsxFileName = "/Users/jasonjones/GitHubData/BenAwad/typescript-nextjs-graphql-series/pages/_app.tsx";
